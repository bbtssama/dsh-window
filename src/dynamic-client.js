    ...
    function NoteCard(props) {
      ...
      React.useEffect(function () {
        ...
        const onDown = function (ev) {
          ...
          // Clicking another CELL hands the editor over to it (startCellEdit runs from the click
          // handler); anything else commits.
          if (node && node.closest && node.closest('[data-cell-at]')) return
          commitCellEdit(0)
        }
