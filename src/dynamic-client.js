...
return {
  ...
  apply(ctx) {
    ...
    function NoteCard(props) {
      ...
      /** Open one of the chrome menus under the button that was clicked. */
      ...
      const notesRow = h('div', {
        ...
        h('button', {
          className: 'dn-notes-pick', key: 'pick', type: 'button',
      ...
      const actions = h('div', { className: 'dn-actions', key: 'actions' }, [
        ...
        h('button', {
          className: 'dn-btn dn-btn-icon', key: 'more', type: 'button', title: '更多：清空全部标记 / 从磁盘重载',
      ...
      const marksHeadEl = h('div', {
        ...
        h('button', {
          className: 'dn-tab dn-tab-on dn-marks-view', key: 'view', type: 'button',
