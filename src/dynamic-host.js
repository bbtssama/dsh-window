...
return {
  apply(ctx) {
    ...
    registerToolLocked(harness.defineTool({
      name: 'note_status',
      description: '一次调用判断「要不要读点东西」（≤0.3 KB）：rev / git / 行数 / 标记数 + 自你上次读取以来的改动量。没有改动就不要读正文。',
