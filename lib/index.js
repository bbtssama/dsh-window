...
export function apply(ctx, config) {
  ...
  void config
    ...
    async function persistState() {
      ...
      const payload = { v: STATE_VERSION, seq: S.seq, selections: S.selections, updatedAt: isoNow(), contentSha: contentHashOf(S.text), headRev: S.commitHash || '', lastRead: S.lastRead || null }
