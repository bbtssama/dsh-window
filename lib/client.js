          ...
          bodyKids.push(h('div', { className: 'dn-bar', key: 'bar', style: { left: Math.max(4, anchor.x - 10) + 'px', top: barTop + 'px', pointerEvents: ovPe } }, [
            h('span', { className: 'dn-pen', key: 'pen' }, [
              ...
              penOpen ? h('span', { className: 'dn-pen-pop', key: 'pop' }, PEN_COLORS.map(function (c) {
                return h('button', { className: 'dn-pen-sw', key: c, 'data-c': c, title: c, 'data-on': c === penColor ? 'true' : 'false', onClick: function (e) { e.stopPropagation(); setPenColor(c); writePenColor(c); setPenOpen(false) } })
              })) : null,
            ]),
